		...
		<div class="panel panel-info">
			<div class="panel-heading">				
				<form class="form-inline" name="frm_search" method="GET">
					...
					<a href="{{route('vacation_list_admin')}}" class="btn btn-danger btn-outline btn-sm" id="reset_filter">Reset</a>
				</form>	
		...
		<div class="panel panel-primary">
			...
			<table class="table table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						<td> 
							<strong>{{ $user_vacation->user_name }}</strong>
						</td>
						<?php 
						...
						<td><a href="{{route('uses_vacation_history_admin',['user_id'=>$user_vacation['user_id']])}}" id="history-vacation-{{$user_vacation['user_id']}}" class="btn btn-outline btn-primary btn-xs"><span>詳細</span></a></td>
					@endforeach                    
				</tbody>
			</table>
