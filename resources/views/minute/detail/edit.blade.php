...
<div class="row minute_wrap">
	<div class="col-md-12">
		<h1 class="page-header">{{ $minutes_group->minutes_group_name }}の議事録編集</h1>
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="{{url('minute/detail/update')}}/{{ $minutes_detail['minutes_detail_id'] }}" method="post" autocomplete="off" class="form-horizontal form-label-left">
				...
				<div class="form-group {{ $errors->has('minutes_detail_date') ? 'has-error' : '' }}">
					...
					<div class="col-md-3">
						<div class="input-group">
							<input type="text" class="form-control date" name="minutes_detail_date" value="{{ $minutes_detail['minutes_detail_date'] }}">
				...
				<div class="form-group {{ $errors->has('minutes_detail_agenda') ? 'has-error' : '' }}">
					...
					<div class="col-md-8">
						<textarea class="form-control" name="minutes_detail_agenda" placeholder="" rows=7>{{ $minutes_detail['minutes_detail_agenda'] }}</textarea>
				...
				<div class="form-group {{ $errors->has('minutes_detail_text') ? 'has-error' : '' }}">
					...
					<div class="col-md-8">
						<textarea id="editor" class="form-control" name="content" placeholder="" rows=20>{{ $minutes_detail['minutes_detail_text'] }}</textarea>
