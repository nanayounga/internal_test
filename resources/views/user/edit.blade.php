	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="{{url('user/update'). '/'. $user['user_id']}}" method="post" autocomplete="off" class="form-horizontal form-label-left">
				...
				<div class="form-group {{ $errors->has('user_kanji_last_name') ? 'has-error' : '' }}">
					...
					<div class="col-md-6">
						<input class="form-control" name="user_kanji_last_name" text="text" value="{{ $user['user_kanji_last_name'] }}" maxlength="20" placeholder="山田" required>
				...
				<div class="form-group {{ $errors->has('user_kanji_first_name') ? 'has-error' : '' }}">
					...
					<div class="col-md-6">
						<input class="form-control" name="user_kanji_first_name" text="text" value="{{ $user['user_kanji_first_name'] }}" maxlength="20" placeholder="太郎" required>
				...
				<div class="form-group {{ $errors->has('user_kata_last_name') ? 'has-error' : '' }}">
					...
					<div class="col-md-6">
						<input class="form-control" name="user_kata_last_name" text="text" value="{{ $user['user_kata_last_name'] }}" maxlength="20" placeholder="ヤマダ" required>
				...
				<div class="form-group {{ $errors->has('user_kata_first_name') ? 'has-error' : '' }}">
					...
					<div class="col-md-6">
						<input class="form-control" name="user_kata_first_name" text="text" value="{{ $user['user_kata_first_name'] }}" maxlength="20" placeholder="タロウ" required>
				...
				<div class="form-group {{ $errors->has('user_email') ? 'has-error' : '' }}">
					...
					<div class="col-md-6">
						<input class="form-control" name="user_email" type="email" value="{{ $user['user_email'] }}" placeholder="gakushu@gmail.com" maxlength="50" value="" required>
				...
				<div class="form-group {{ $errors->has('user_password') ? 'has-error' : '' }}">
					...
					<div class="col-md-6">
						<input class="form-control" name="user_password" type="password" value="{{ old('user_password') }}" placeholder="6文字以上のパスワード" maxlength="50">
				...
				<div class="form-group {{ $errors->has('user_password') ? 'has-error' : '' }}">
					...
					<div class="col-md-6">
						<input class="form-control" name="user_password_confirm" type="password" value="{{ old('user_password_confirm') }}" placeholder="6文字以上のパスワード(確認用)" maxlength="50">
				...
				<div class="form-group {{ $errors->has('department_id') ? 'has-error' : '' }}">
					...
					<div class="col-md-6">
						...
						@foreach ($departments as $department)
							<option value="{{$department->department_id}}" @if($user['department_id']==$department->department_id) selected @endif>{{$department->department_name}}</option>
						@endforeach
						</select>
