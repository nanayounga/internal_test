...
<div class="row">
	...
	<form action="{{ url('sale/department/update/' . $sales_department['sales_department_id'])}}" method="post" autocomplete="off" class="form-horizontal form-label-left">
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group {{ $errors->has('sales_department_name') ? 'has-error' : '' }}">
					...
					<div class="col-md-6">
						<input class="form-control" name="sales_department_name" text="text" value="{{ $sales_department['sales_department_name'] }}" maxlength="20" placeholder="システム開発部" required>
				...
				<div class="form-group {{ $errors->has('sales_department_start') ? 'has-error' : '' }}">
					...
					<div class="col-md-3">
						<div class="input-group">
							<input type="text" class="form-control date" name="sales_department_start" value="{{ $sales_department['sales_department_start'] }}" placeholder="Start">
					...
					<div class="col-md-3">
						<div class="input-group">
							<input type="text" class="form-control date" name="sales_department_end" value="{{ $sales_department['sales_department_end'] }}" placeholder="End">
							<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
						</div>
		...
		<input type="hidden" name="sales_department_id" value="{{ $sales_department['sales_department_id'] }}">
