...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'user_email' => [
            'duplicate_email_update' => '既に使用されている:attributeです。',
        ],
        'department_name' => [
            'duplicate_department_name' => '既に使用されている:attributeです。',
        ],
        'sales_department_name' => [
            'duplicate_sales_department_name' => '既に使用されている:attributeです。',
        ],
        'sales_value' => [
            'edit_sales_permission' => '編集権限がありません。',
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'user_email' => 'メールアドレス',
        'user_password' => 'パスワード',
        'user_password_confirm' => 'パスワード確認用',
        'department_name' => '部署名',
        'department_id' => '所属部署',
        'minutes_group_desc' => 'グループの概要',
        'minutes_detail_date' => '開催日',
        'minutes_detail_text' => '議事録',
        'minutes_user_id' => 'ユーザー',
        'sales_department_name' => '部署名',
        'sales_value' => '金額',
        'sales_cost_value' => '経費金額',
    ],
