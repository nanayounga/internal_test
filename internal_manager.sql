...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 11, 2018 at 07:45 AM
...
--
-- Database: `internal_manager`
--

-- --------------------------------------------------------

--
-- Table structure for table `auto_logins`
--

DROP TABLE IF EXISTS `auto_logins`;
CREATE TABLE IF NOT EXISTS `auto_logins` (
  `auto_login_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  UNIQUE KEY `auto_logins_auto_login_id_user_id_unique` (`auto_login_id`,`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `auto_logins`
--
...
('A6bm9_skhI6dPg51IoktqrJ6jRskKWgUHc9-4Rt0hurpFdsURWRDgFsZc05SblofsQbpJryYSesQjis1IDU7uU1gndUEjXmHo1glfGLt9SV3rqTWXNserO5hheoDVYiMMvwd68cYJYhWDwytgvHv4zFxOAJQyu0ql0cQSKVYLlsI3Z0vYNcQ', 325, '2018-10-11 16:37:27', '2018-10-11 16:37:27'),
...
('Aiw-QIa_w0xpnd7slYs3vU-rf_APQZu3VniRKHQDwC_kXKxAmme_atXD53DNvlgjC88VXHR7wQduaPMjlgycSUv08gJqSgpRjsm4lRSgqDVpDJPNGER1R0n5cnRf9qtA9TYtusE-JYvHI8hTU6tdICC6F7SLK79uUCR6Hg8PCdRR_HZtoXTU', 2, '2018-07-14 21:25:07', '2018-09-21 20:37:10'),
...
('g3mF92eybs3gB0GXnsoSJKTvrD51X1oBBF2o0nkR7r-dWQPINIdYAqMJZ3vZqYS9J_wqUdNWfx8XhIE0qAW-kFjVNxpej-FxxrEyYSRgTqyJs0jfguugTx7uCI2g5-LtagcCzs1qVWnmaXZu7a9RWOuEzsxj2oHb6g0TKHk9ShWQnNa0v6z5', 324, '2018-10-11 16:39:39', '2018-10-11 16:39:39'),
...
('GvbxANcbstfAF5rvFB9WJbw4K82SV8GzMZ_UGuO59WOJrgtiNbAuM9YqqueHEm68fg4baB4ia1_ehOu-VI7uqxitcMwgZK6u1wn3ginDVC_OCBLRptJM1E77RwfFMrzonlcXETRt7s2ExoQKtW5fmYdtzAio6U0p8_FdAHFt85v-bq0hwgTz', 2, '2018-04-23 11:32:24', '2018-09-26 10:12:43'),
...
('x9PMq8EWxJQEp2FnrxgjNz0RVcX1Nt8wKE41C2LC_MbiehHpU_tRIBBJQZIoJaqv-ZmX0rn4dQEzv-LjV4tBtu9QHe82MSheZdhwoivzAa2UDFJThkO80YDP_ty2w7l1dRCcbvYAhyx4nUJQc7c4NwLmj4YVVos35nCua2U-vzS_slFvGpmw', 325, '2018-10-11 16:38:11', '2018-10-11 16:38:11'),
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='部署';
...
--
-- Table structure for table `minutes_details`
--

DROP TABLE IF EXISTS `minutes_details`;
CREATE TABLE IF NOT EXISTS `minutes_details` (
  `minutes_detail_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`minutes_detail_id`)
) ENGINE=InnoDB AUTO_INCREMENT=113 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `minutes_details`
--
...
--
-- Table structure for table `minutes_groups`
--

DROP TABLE IF EXISTS `minutes_groups`;
CREATE TABLE IF NOT EXISTS `minutes_groups` (
  `minutes_group_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`minutes_group_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1031 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='議事録グループ管理';

--
-- Dumping data for table `minutes_groups`
--
...
--
-- Table structure for table `minutes_users`
--

DROP TABLE IF EXISTS `minutes_users`;
CREATE TABLE IF NOT EXISTS `minutes_users` (
  `minutes_group_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  UNIQUE KEY `minutes_users_minutes_group_id_user_id_unique` (`minutes_group_id`,`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `minutes_users`
--
...
--
-- Table structure for table `paid_vacations`
--

DROP TABLE IF EXISTS `paid_vacations`;
CREATE TABLE IF NOT EXISTS `paid_vacations` (
  `vacation_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `paid_vacations`
--
...
(35, '2018-09-27', 'AL', '', 0, 'waitting', NULL, '2018-09-24 04:15:19', '2018-09-24 04:15:19', 2);
...
--
-- Table structure for table `permission_passwords`
--

DROP TABLE IF EXISTS `permission_passwords`;
CREATE TABLE IF NOT EXISTS `permission_passwords` (
  `permission_password_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `permission_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `permission_password` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `last_login_at` datetime NOT NULL,
  PRIMARY KEY (`permission_password_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `permission_passwords`
--
...
CREATE TABLE IF NOT EXISTS `permission_types` (
  `permission_type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `salaries` (
  ...
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  UNIQUE KEY `salaries_user_id_unique` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `sales_costs` (
  `sales_cost_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`sales_cost_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='部署毎の月の経費';
...
CREATE TABLE IF NOT EXISTS `sales_departments` (
  `sales_department_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`sales_department_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='売上管理で使用する部署名';
...
--
-- Table structure for table `sales_weeks`
--

DROP TABLE IF EXISTS `sales_weeks`;
CREATE TABLE IF NOT EXISTS `sales_weeks` (
  `sales_week_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`sales_week_id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='週毎の目標売上や結果';

--
-- Dumping data for table `sales_weeks`
--
...
CREATE TABLE IF NOT EXISTS `service_workers` (
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`user_id`,`service_worker_token`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `service_workers`
--
...
('7f759efe3ee3e8bcae9ff88d08d96c6716ee9260', '', 1539243862);
...
(2, '進藤', '', '', '', 'shindo@remcorp.jp', '$2y$10$lmqlvAYWqmkC9NXcIp.pYu68jMTAgErcpBsk02bq/pHQJxJzs3KOW', 19, NULL, NULL, '2018-09-26 10:12:43', '2017-06-13 07:25:54', '2018-09-26 10:12:43'),
...
(324, 'Nga', '', '', '', 'nga@remcorp.jp', '$2y$10$/Rurqq0HvneEkFOtS7Vo4.hpbgGbzJzUIMDoBu.Sgrjhhoxy4EmBa', 21, NULL, NULL, '2018-10-11 16:39:39', '2017-07-26 06:11:09', '2018-10-11 16:39:39'),
(325, 'Dung', '', '', '', 'dung@remcorp.jp', '$2y$10$/Rurqq0HvneEkFOtS7Vo4.hpbgGbzJzUIMDoBu.Sgrjhhoxy4EmBa', 21, NULL, NULL, '2018-10-11 16:38:11', '2017-07-26 06:11:33', '2018-10-11 16:38:11'),
...
CREATE TABLE IF NOT EXISTS `user_banks` (
  ...
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  UNIQUE KEY `user_banks_user_id_unique` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `user_detail_logs`
--

DROP TABLE IF EXISTS `user_detail_logs`;
CREATE TABLE IF NOT EXISTS `user_detail_logs` (
  `user_detail_log_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`user_detail_log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `user_detail_logs`
--
